...
!(function() {
  try {
    ...
    n && ((e._debugIds || (e._debugIds = {}))[n] = "24d126f8-22d7-02bc-90a9-ab7d305810e5");
  } catch (e2) {
  }
})();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 387785, (e) => {
  "use strict";
  var t = e.i(68982), a = e.i(856757), r = e.i(890938);
  try {
    var n = window;
  ...
  e.s(["ChangelogEntryTitle", 0, function({ children: e2, slug: n2, year: i2 }) {
    let [l, c] = (0, a.useState)(false);
    return (0, t.jsxs)("span", { className: "group/permalink inline-flex items-center gap-2", children: [e2, (0, t.jsxs)("button", { type: "button", className: (0, s.cn)("relative", "before:absolute before:-inset-2", "rounded-md bg-surface-subtle", "font-medium text-tertiary-foreground text-xs", "flex shrink-0 items-center justify-center gap-0.5 p-1", "cursor-pointer", "-translate-x-0.5 group-hover/permalink:translate-x-0", "opacity-0 group-hover/permalink:opacity-100", "active:scale-95 active:bg-blue-100 active:text-blue-600", "transition-all duration-150", "max-lg:hidden"), onClick: () => {
      navigator.clipboard.writeText(`${window.location.origin}/changelog/${i2}/${n2}`), c(true);
    }, onMouseLeave: () => {
      l && setTimeout(() => {
        c(false);
      }, 600);
    }, "aria-label": "Copy link", tabIndex: -1, children: [l ? (0, t.jsx)(r.Check14, {}) : (0, t.jsx)(o, {}), (0, t.jsx)("span", { className: "sr-only", children: "Copy link to this entry" })] })] });
  }], 387785);
}, 180713, (e) => {
  "use strict";
  var t = e.i(856757);
  ...
  e.s(["ScrollToTop", 0, function() {
    return (0, t.useEffect)(() => (history.scrollRestoration = "manual", window.scrollTo(0, 0), () => {
